...
//  it("determines the width of an array", function () {
...
//  });
//
//  it("works when fetching from nested arrays", function () {
//    var program = Level3Compiler.compile({
//      instructions: [
//        { type: "constant", value: 1 },
//        { type: "constant", value: 2 },
...
//  });
  ...
  it("works when there are multiple fetch restrictions", function () {
    var program = Level3Compiler.compile({
      instructions: [
        { type: "constant", value: 1 },
        { type: "constant", value: 2 },
